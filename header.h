...
/* FIX: extern so these are declared (not defined) in every .c that includes
   this header. Actual definitions live in parser.c (one translation unit). */
...
/* strlwr is Windows-only; provide it for Linux/GCC */
#ifndef _WIN32
